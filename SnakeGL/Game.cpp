...
void Game::Menu()
{
    ...
    if (endGame) {
        if (win) txt->RenderText("YOU WIN!", glm::vec2(this->width / 2.0f - 125.0f, this->height / 2.0f - 216.0f), 2.0f, glm::vec3(0.75f, 0.0f, 0.75f));
        else txt->RenderText("YOU LOSE", glm::vec2(this->width / 2.0f - 125.0f, this->height / 2.0f - 216.0f), 2.0f, glm::vec3(0.75f, 0.0f, 0.0f));
